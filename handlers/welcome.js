  ...
  client.on("guildMemberAdd", async mem => {
    ...
    async function welcome(member) {
      ...
      if (invite && inviter) {
        ...
        invitemessage = `Invited by ${inviter.tag ? `**${inviter.tag}**` : `<@${inviter.id}>`}\n<:like:949754769814220860> **${realinvites} Invite${realinvites == 1 ? "" : "s"}**\n[<:join:949745467443544155> ${invites} Joins |<:leave:949745541485559829> ${leaves} Leaves | <:fake:949745617754787911> ${fake} Fakes]`;
      } 
      else if(invite){
