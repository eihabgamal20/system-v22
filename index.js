...
module.exports = async (client) => {
  ...
  process.on('multipleResolves', (type, promise, reason) => { // Needed
    console.log('=== [antiCrash] 〢 [multipleResolves] 〢 [start] ==='.yellow.dim);
     console.log(type, promise, reason);
    console.log('=== [antiCrash] 〢 [multipleResolves] 〢 [end] ==='.yellow.dim);
  });
  process.on('unhandledRejection', (reason, promise) => { // Needed
    console.log('=== [antiCrash] 〢 [unhandledRejection] 〢 [start] ==='.yellow.dim);
    console.log(reason);
    console.log('=== [antiCrash] 〢 [unhandledRejection] 〢 [end] ==='.yellow.dim);
  });
  process.on('rejectionHandled', (promise) => { // If You Want You Can Use
    console.log('=== [antiCrash] 〢 [rejectionHandled] 〢 [start] ==='.yellow.dim);
    console.log(promise);
    console.log('=== [antiCrash] 〢 [rejectionHandled] 〢 [end] ==='.yellow.dim);
  })
  process.on("uncaughtException", (err, origin) => { // Needed
    console.log('=== [antiCrash] 〢 [uncaughtException] 〢 [start] ==='.yellow.dim);
    console.log(err);
    console.log('=== [antiCrash] 〢 [uncaughtException] 〢 [end] ==='.yellow.dim);
  });
  process.on('uncaughtExceptionMonitor', (err, origin) => { // Needed
    console.log('=== [antiCrash] 〢 [uncaughtExceptionMonitor] 〢 [start] ==='.yellow.dim);
    console.log(err);
    console.log('=== [antiCrash] 〢 [uncaughtExceptionMonitor] 〢 [end] ==='.yellow.dim);
  });
...
module.exports = {
  ...
  run: async (client, message, args) => {
    message.channel.permissionOverwrites.edit(message.guild.id, {
      SEND_MESSAGES: true //change here... xd
    });
