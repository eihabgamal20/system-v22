  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("").setLabel("ديسكورد الدعم الفني للبوت").setURL("https://discord.gg/YHNkeZfk9S")
        let menuOptions = [
          {
            label: "Overview",
            value: "Overview",
...
<:ELBOB Development>  Made by [**ELBOB Development**](https://discord.gg/kRjaSfeSFV)`)
